...
const Blogs = () => {
  ...
  const Search = {
    ...
    boxShadow:
      "1px 1.5px 4px 0px rgba(0, 0, 0, 0.10) inset, 1px 1.5px 4px 0px rgba(0, 0, 0, 0.08) inset, 0px -0.5px 1px 0px rgba(255, 255, 255, 0.25) inset, 0px -0.5px 1px 0px rgba(255, 255, 255, 0.30) inset",
  };
  const imgStyle = {
    width: "12.4rem",
    height: "12.4rem",
    ...
    <>
      ...
      >
        <div className="w-full relative h-[80%]  flex justify-center">
          <div
            className="w-[68%]  flex items-start pt-10 pl-14 pb-0 pr-14 flex-col gap-5 text-3xl mt-10  "
            style={blogStyle}
