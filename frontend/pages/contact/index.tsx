...
export default function Home() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-center bg-no-repeat bg-cover" style={{ backgroundImage: "url('/bg.png')" }}>
            <Head>
                <title>Contact Page</title>
            </Head>
            <div className="flex items-center justify-center mt-4 xs:h-[8vh] sm:h-[8vh] md:hidden ml:hidden">
                <div className="flex justify-between w-full max-w-md p-4 mg:w-[90vw] sm:w-[90vw] xs:w-[90%]">
                    <button
            ...
            <div className="flex items-center justify-center mb-8 text-center md:mb-4">
            ...
            <div className="flex flex-col w-full pb-0 mx-auto jus lg:w-8/12 md:p-10 md:pb-16 ml:pt-4 ml:pb-16">
                ...
                <div className="flex flex-wrap items-center justify-center w-full gap-16 mx-auto mg:mb-8 ml:hidden md:w-11/12">
                    <Link href="mailto:example@example.com" className="flex items-center justify-center bg-blue-100 rounded-full w-28 h-28 mg:w-24 mg:h-24">
                        <img src="images/mail.png" alt="Mail" className="w-full h-full" />
                    </Link>
                    <Link href="tel:+123456789" className="flex items-center justify-center bg-green-100 rounded-full w-28 h-28 mg:w-24 mg:h-24">
                        <img src="images/phone.png" alt="Phone" className="w-full h-full" />
                    </Link>
                    <Link href="https://twitter.com" className="flex items-center justify-center bg-blue-100 rounded-full w-28 h-28 mg:w-24 mg:h-24">
                        <img src="images/twitter.png" alt="Twitter" className="w-full h-full" />
                    </Link>
                    <Link href="https://linkedin.com" className="flex items-center justify-center bg-blue-100 rounded-full w-28 h-28 mg:w-24 mg:h-24">
                        <img src="images/linkedin.png" alt="LinkedIn" className="w-full h-full" />
                    </Link>
                    <Link href="https://facebook.com" className="flex items-center justify-center bg-green-100 rounded-full w-28 h-28 mg:w-24 mg:h-24">
                        <img src="images/fb.png" alt="Facebook" className="w-full h-full" />
                    </Link>
                    <Link href="https://instagram.com" className="flex items-center justify-center bg-blue-100 rounded-full w-28 h-28 mg:w-24 mg:h-24">
                        <img src="images/insta.png" alt="Instagram" className="w-full h-full" />
                    </Link>
                    <Link href="https://maps.google.com" className="flex items-center justify-center bg-green-100 rounded-full w-28 h-28 mg:w-24 mg:h-24">
                        <img src="images/map.png" alt="Google Maps" className="w-full h-full" />
                    </Link>
                </div>
            </div>
